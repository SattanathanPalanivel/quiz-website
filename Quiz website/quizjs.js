...
const questions = [
    ...
    {
        title : 'The latest HTML standard is ?',
        options : [
            'HTML 4.0',
            'HTML 5.0',
            'XML',
    ...
    {
        title : 'Which of the following is used to transmit information on the world wide web ?',
        options : [
            'HTTP',
            'HTML',
            'URL',
    ...
    {
        title : 'Which of the following programming languages is commonly used for server-side scripting in web development',
        options : [
            ' HTML',
            'CSS',
            'JavaScript',
    ...
    {
        title : 'Which attribute is used to provide a unique name to an HTML element ?',
        options : [
            'Id',
            'Class',
            'Type',
    ...
    {
        title : 'Which HTML element is used to define description data?',
        options : [
            'li',
            'ol',
            'dd',
    ...
    {
        title : 'Identify the total standard color names that HTML supports ?',
        options : [
            '85',
            '30',
            '120',
